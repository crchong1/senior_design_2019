              ...
              <div className="col-md-12 mt-5">
                ...
                <div className="row mt-2">
                  <div className="col-md-5">
                    ...
                    <input type="tel" className="form-control" id="phoneNumber" placeholder="1-(234)-567-8901" />
                  </div>
                ...
                <div className="row mt-2">
                  <div className="col-md-4">
                    ...
                    <input type="text" className="form-control" id="mailingAddress" placeholder="311 Broad St" />
                  </div>
                  <div className="col-md-3">
                    <label htmlFor="inputCity">City</label>
                    <input type="text" className="form-control" id="city" placeholder="Philadelphia" />
                  </div>
                  <div className="col-md-2">
                    <label htmlFor="inputState">State</label>
                    <input type="text" className="form-control" id="lastName" placeholder="PA" />
                  </div>
                  <div className="col-md-3">
                    <label htmlFor="inputZipCode">Zip Code</label>
                    <input type="number" className="form-control" id="zipCode" placeholder="19104" />
                  </div>
                </div>
                <div className="row mt-2">
                  <div className="col-md-4">
